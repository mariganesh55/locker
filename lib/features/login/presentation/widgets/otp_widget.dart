...
import 'package:locker/features/login/presentation/pages/reset_password_screen.dart';
        ...
        if(val.length == 1){
          ...
          if(index == 4){
            if(widget.forgotPassword != null){
              ...
              Navigator.pop(context);
              Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: const ResetPasswordScreen(), duration: const Duration(milliseconds: 250)));
            }
